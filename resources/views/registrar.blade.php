  ...
  <div class="container card text-center mt-5 w-50 mb-5 px-0">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active rgb" aria-current="true" href="registrar">Registro Usuario</a>
        </li>
        <li class="nav-item">
    ...
    <div class="card-body">
      ...
      <div class=" d-flex justify-content-around text-start mx-5">
        ...
        <form method="POST" action="{{ url('/registerstudent') }}">
          ...
          <p>DNI</p>
          <input id="dni" type="text" class="form-control @error('dni') is-invalid @enderror" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="dni" value="{{ old('dni') }}" required autocomplete="dni" autofocus> <br>
