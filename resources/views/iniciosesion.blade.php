  ...
  <div class="container card text-center mt-5 w-50 px-0">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        <li class="nav-item">
          <a class="nav-link active rgb" aria-current="true" href="iniciosesion.html">Inicio de sesión</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="true" href="registrar.html">Registro Usuario</a>
        </li>
        <li class="nav-item">
    ...
    <div class="card-body">
      ...
      <form action="">
         <p>Email</p><input type="text" class="form-control" aria-label="Sizing example input"
